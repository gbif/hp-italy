...
[![Build Status](https://builds.gbif.org/job/hp-italy/badge/icon)](https://builds.gbif.org/job/hp-italy/lastBuild/console)
...
# GBIF Hosted Portal: italy

This Jekyll website, **[italy (Staging)](https://italy.hp.gbif-staging.org/)**, makes use of a theme and biodiversity widgets developed by the GBIF network.
